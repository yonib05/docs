...
| Parameter | Description | Example | Options |
| --------- | ----------- | ------- | ------- |
| `audio` | `AudioConfig` instance. | `{"voice": "coral"}` | [reference](../../../../../api-reference/experimental/bidi/types/index.md#strands.experimental.bidi.types.model.AudioConfig) |
...
- [Provider API Reference](../../../../../api-reference/experimental/bidi/models/index.md#strands.experimental.bidi.models.openai_realtime.BidiOpenAIRealtimeModel)
