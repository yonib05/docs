...
| --------- | ----------- | ------- | ------- |
| `audio` | `AudioConfig` instance. | `{"voice": "tiffany"}` | [reference](../../../../../api-reference/experimental/bidi/types/index.md#strands.experimental.bidi.types.model.AudioConfig) |
...
- [Provider API Reference](../../../../../api-reference/experimental/bidi/models/index.md#strands.experimental.bidi.models.nova_sonic.BidiNovaSonicModel)
